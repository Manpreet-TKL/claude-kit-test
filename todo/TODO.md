...
- [ ] 2026-08-19 - OpenEyes -> Laravel rewrite (plan: openeyes-laravel-rewrite-plan.md, master plan: openeyes-laravel-rewrite-master-plan.md) [execution active from pinned legacy ad232408, Laravel 6ad9017 and Docker ef578cd baselines; partial-module closure first, then consecutive disjoint waves until exact weighted coverage is greater than 40 percent, preferably 41.5 percent]
