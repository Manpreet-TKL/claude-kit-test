...
- **One mission per workspace.** If the user wants to learn two unrelated things, that is two workspaces under `~/teach/`.
- **Concrete over abstract.** "Run a half marathon by October" beats "get fitter". "Ship a Rust CLI to my team" beats "learn Rust".
- **Push back on vagueness.** If the user cannot articulate why, interview them before writing anything - `c-grill-me` is the tool for it. A bad mission is worse than no mission.
- **Revise when reality shifts.** Missions change. When the user's goal moves, update this file; do not leave a stale mission steering future sessions.
