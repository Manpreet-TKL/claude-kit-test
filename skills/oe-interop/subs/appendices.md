...
- **Appendix B – PAS API** — PASAPI reference, including v2 GP/Practice import endpoints and examples. See the `pasapi` sibling skill for the actual PASAPI v2 contract.
