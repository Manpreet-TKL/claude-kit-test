---
name: oe-db-schema
description: OpenEyes DB — connecting, schema navigation, domain model
...
- Data context = session site + firm + institution — filters almost every query (`CurrentContextSettingsService`). Firm ≈ consultant team × subspecialty; episodes are owned per firm.
