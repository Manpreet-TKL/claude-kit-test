...
description: "Full TKLS corpus (9,940 tickets + attachments, 22 GB) DOWNLOADED to ~/tkls-corpus-full (complete by 2026-08-19); analysis brief queued in kit todo/ - stats gate before any model pass."
metadata: 
  node_type: memory
  type: project
...
Full TKLS download (9,940 tickets, all attachment binaries) into `~/tkls-corpus-full/`
...
command resumes idempotently: `bash ~/claude-kit/scripts/jira_filter_download.sh -j 'project = TKLS ORDER BY created ASC' -a -r -o /home/toukan/tkls-corpus-full`
